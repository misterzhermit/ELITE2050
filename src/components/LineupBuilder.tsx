      ...
      <div className="flex-1 flex flex-col gap-4 min-h-[450px]">
        ...
        <div className="bg-black/40 backdrop-blur-md border border-white/10 rounded-xl p-4 flex items-center justify-between shadow-lg">
          ...
          <button
            ...
            disabled={isSaving}
            className={`flex items-center gap-2 px-4 py-2 rounded-xl font-bold transition-all shadow-lg border ${isSaving
          ...
          {FORMATION_SLOTS.map(slot => {
            ...
            return (
              <div
                ...
                className={`absolute -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center transition-all duration-300 w-20 h-28 z-10 cursor-pointer ${canReceiveDrop
                    ? 'scale-105 z-20'
                    : ''
                  }`}
                ...
                {player ? (
                  <div className="relative group w-full flex flex-col items-center">
                    <div
                      ...
                      className={`transform hover:scale-110 transition-transform duration-200 relative z-20 w-16 h-16 cursor-pointer flex items-center justify-center ${isSelected
                    ...
                    <div className={`mt-1 whitespace-nowrap px-2 py-0.5 rounded-lg text-[10px] font-bold backdrop-blur-sm border uppercase tracking-wider shadow-lg ${player.role === slot.label
                  ...
                  <div className={`w-16 h-16 rounded-xl border-2 border-dashed flex items-center justify-center shadow-[0_0_15px_rgba(16,185,129,0.1)] transition-all group ${canReceiveDrop
